  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 group flex flex-col border border-slate-200 dark:border-slate-700">
      <ImageCarousel 
        ...
        onImageClick={() => onOpenDetailModal(property)}
      >
        <div className="absolute top-3 right-3 flex flex-col space-y-2 z-10" ref={shareRef}>
            <button
                onClick={(e) => handleIdActionClick(e, onSaveToggle)}
                className="bg-white/90 backdrop-blur-sm p-2 rounded-full text-slate-700 hover:text-brand-accent hover:bg-white shadow-sm transition-all duration-300"
            ...
            <button
                ...
                className={`bg-white/90 backdrop-blur-sm p-2 rounded-full text-slate-700 hover:bg-white shadow-sm transition-all duration-300 ${isCompared ? 'text-brand-primary' : ''}`}
            ...
            {property.vrTourUrl && (
                <button
                    ...
                    className="bg-brand-primary text-white p-2 rounded-full shadow-lg hover:scale-105 transition-all duration-300"
             ...
             <div className="relative">
                <button
                    ...
                    className="bg-white/90 backdrop-blur-sm p-2 rounded-full text-slate-700 hover:text-brand-primary hover:bg-white shadow-sm transition-all duration-300"
        ...
        <div className="absolute top-3 left-3 flex flex-col items-start gap-y-1.5 z-10 pointer-events-none">
