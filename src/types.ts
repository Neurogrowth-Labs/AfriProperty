...
export interface PaymentMethod {
    ...
    expiryYear: number;
    isDefault: boolean;
    // FIX: Added providerType and gatewayName to satisfy requirements in lib/data.ts and advanced billing components
...
export interface Property {
  ...
  vrTourUrl?: string;
  // FIX: Added id to agent property
  agent: {
    id: string;
...
// Fixed User interface to include id and verification fields
export interface User {
  id: string; // Added Supabase Auth UUID
...
// Fixed TourRequest to include userId and ensure consistency
