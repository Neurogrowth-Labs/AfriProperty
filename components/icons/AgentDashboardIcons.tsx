...
export const ListingsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5M3.75 21H6.5m0 0V4.5m0 16.5h-3M6.5 4.5H21V21H6.5" />
  </svg>
);
...
export const HandshakeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.828 21.086L6.832 15.09a2.25 2.25 0 00-3.182 3.182l6.993 6.994a2.25 2.25 0 003.183 0l6.993-6.994a2.25 2.25 0 00-3.182-3.182L12.829 21.086z" />
    </svg>
);
...
export const RocketLaunchIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a6 6 0 01-2.56 5.84m-2.56-5.84a6 6 0 017.38-5.84m-4.82 5.84v-4.82m-2.56 5.84a6 6 0 01-5.84-2.56m5.84-4.82a6 6 0 01-5.84-7.38m2.56 5.84H6.84m4.82 2.56a6 6 0 01-7.38 5.84m5.84-4.82H6.84" />
  </svg>
);
