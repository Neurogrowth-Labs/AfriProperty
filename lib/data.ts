...
/**
 * FIX: Added missing provider_type and gateway_name to insert payload 
 * and fixed return object to include providerType and gatewayName as required by types.
 */
